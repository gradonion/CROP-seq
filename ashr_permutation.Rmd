---
title: "Permutation test -- ashr on sctransformed CROP-seq data"
author: "Yifan Zhou"
date: "6/16/2019"
output:   
  html_document:
...
For each target gRNA, we selected 2 groups of cells: cells that only contain the target gRNAs, and cells that only contain the negative control gRNAs. We conducted categorical regression on the Pearson residuals (**with the 2 conditions permuted**) to obtain the summary statistics. As before, 70 (gRNA vs neg ctrl) pairs were tested.
...
```{r pval, eval=FALSE, include=FALSE}
